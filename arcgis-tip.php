...
function arcgis_tip_enqueue_scripts () {
  ...
  wp_register_script( 'arcgis-tip', plugins_url( '/js/arcgis-tip.js' , __FILE__ ), array('jquery-datatables', 'arcgis-js-api'), '0.1-5', false );
}
